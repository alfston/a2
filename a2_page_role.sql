...
CREATE TABLE `page_role` (
  ...
  PRIMARY KEY (`id`),
  KEY `developer_page_role_idx` (`developer_id`),
  KEY `page_role_id_idx` (`page_id`),
  ...
  CONSTRAINT `page_role_id` FOREIGN KEY (`page_id`) REFERENCES `pages` (`id`) ON DELETE CASCADE
...
INSERT INTO `page_role` VALUES (4,'editor',234,23),(5,'reviewer',234,34),(6,'writer',234,12),(10,'editor',456,12),(11,'reviewer',456,23),(12,'writer',456,34);
...
-- Dump completed on 2020-10-29  1:43:50
